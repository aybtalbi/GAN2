...
sources                              = {}
sources['jazz']                 = {}
sources['jazz']['CurtisFuller']        = []
sources['jazz']['DavidLiebman']        = []
sources['jazz']['DavidMurray']        = []
sources['jazz']['DexterGordon']        = []
sources['jazz']['DickieWells']        = []
sources['jazz']['DizzyGillespie']        = []
sources['jazz']['DonByas']        = []
sources['jazz']['DonEllis']        = []
sources['jazz']['EricDolphy']        = []
sources['jazz']['FatsNavarro']        = []
sources['jazz']['FreddieHubbard']        = []
sources['jazz']['GeorgeColeman']        = []
sources['jazz']['GerryMulligan']        = []
sources['jazz']['HankMobley']        = []
sources['jazz']['HarryEdison']        = []
sources['jazz']['HerbieHancock']        = []
sources['jazz']['JJJohnson']        = []
sources['jazz']['JoeHenderson']        = []
sources['jazz']['JoeLovano']        = []
sources['jazz']['JohnColtrane']        = []
sources['jazz']['JohnnyDodds']        = []
sources['jazz']['JohnnyHodges']        = []
sources['jazz']['JoshuaRedman']        = []
sources['jazz']['KennyDorham']        = []
sources['jazz']['KennyGarrett']        = []
sources['jazz']['KennyWheeler']        = []
sources['jazz']['KidOry']        = []
sources['jazz']['LeeKonitz']        = []
sources['jazz']['LeeMorgan']        = []
sources['jazz']['LesterYoung']        = []
sources['jazz']['LionelHampton']        = []
sources['jazz']['LouisArmstrong']        = []
sources['jazz']['MichaelBrecker']        = []
sources['jazz']['MilesDavis']        = []
sources['jazz']['MiltJackson']        = []
sources['jazz']['NatAdderley']        = []
sources['jazz']['OrnetteColeman']        = []
sources['jazz']['PatMartino']        = []
sources['jazz']['PatMetheny']   = []
sources['jazz']['PaulDesmond']   = []
sources['jazz']['PepperAdams']   = []
sources['jazz']['PhilWoods']   = []
sources['jazz']['RedGarland']   = []
sources['jazz']['RexStewart']   = []
sources['jazz']['RoyEldridge']   = []
sources['jazz']['SidneyBechet']   = []
sources['jazz']['SonnyRollins']   = []
sources['jazz']['SonnyStitt']   = []
sources['jazz']['StanGetz']   = []
sources['jazz']['SteveColeman']   = []
sources['jazz']['SteveLacy']   = []
sources['jazz']['SteveTurre']   = []
sources['jazz']['VonFreeman']   = []
sources['jazz']['WarneMarsh']   = []
sources['jazz']['WayneShorter']   = []
sources['jazz']['WoodyShaw']   = []
sources['jazz']['WyntonMarsalis']   = []
sources['jazz']['ZootSims']   = []
